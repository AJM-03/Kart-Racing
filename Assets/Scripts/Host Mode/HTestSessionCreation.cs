...
public class HTestSessionCreation : MonoBehaviour
{
    ...
    {
        HTestSpawner.Instance.CreateSession(sessionNameInput.text, passwordInput.text, (int) playerCountSlider.value);
